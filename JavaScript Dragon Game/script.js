...
setInterval(() => {
    ...
    obstical = document.querySelector(".obstacle")
    ...
    if (offsetx < 93 && offsetY < 52) {
        ...
        obstical.classList.remove('obstacleAni');
        audiogo.play();
        setTimeout(() => {
            audio.pause();
           audiogo.pause();
        ...
        setTimeout(() => {
            anidur = parseFloat(window.getComputedStyle(obstical, null).getPropertyValue('animation-duration'));
            newdur = anidur + 0.1;
            console.log(newdur);
